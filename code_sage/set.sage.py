...
# This file was *autogenerated* from the file set.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_21 = Integer(21); _sage_const_0 = Integer(0)
### Tests de RecursivelyEnumeratedSets ###


# A -> Tous les mots de taille <= 21 compose de la lettre a et b
seeds = ['']
succ = lambda m: [m+'a', m+'b'] if len(m) <= _sage_const_21  else []
...
def count(rec_set):
    ...
    map_function = lambda x: _sage_const_1  # Chaque element compte pour 1
    reduce_function = lambda x,y: x+y # On somme les nombre d'elements entre eux (operation associative)
    reduce_init = _sage_const_0  # On demarre le compteur a 0
